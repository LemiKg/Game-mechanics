...
## FPS test player script demonstrating FPSPlayerController3D with state machine.
...
func _toggle_inventory() -> void:
	...
	# Disable/enable gameplay through the controller (uses state machine internally)
