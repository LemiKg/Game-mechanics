...
## Third-person test player script demonstrating ThirdPersonController3D with orbit camera.


@onready var player_controller: ThirdPersonController3D = $ThirdPersonController3D
...
func _ready() -> void:
	...
	# Connect to mouse capture signal
...
func _add_test_items() -> void:
	...
	print("Third-Person Test: Items added to inventory!")
